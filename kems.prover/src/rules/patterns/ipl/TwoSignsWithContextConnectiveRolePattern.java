 ...
 *  
 */
public class TwoSignsWithContextConnectiveRolePattern implements
    ...
    public TwoSignsWithContextConnectiveRolePattern(FormulaSign mainSign,
    ...
    public TwoSignsWithContextConnectiveRolePattern(FormulaSign mainSign,
            ...
            FormulaSign auxiliarySign,
            LabelConditionOperator labelCondition,
            KERuleRole auxiliaryRole) {
        _mainSign = mainSign;
        _mainConnective = mainConnective;
        _auxiliarySign = auxiliarySign;
