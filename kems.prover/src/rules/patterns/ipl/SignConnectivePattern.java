 ...
 *  
 */
public class SignConnectivePattern implements IUnaryLabelledFormulaPattern{
	...
	public boolean matches(LabelledFormula lf) {
        return lf.getSignedFormula().getSign().equals(_sign) && matchesConnective(lf.getSignedFormula().getFormula());
	}
}
