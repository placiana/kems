...
public class IPLTwoLevelCompositeBinaryFormulaPattern implements IBinarySignedFormulaPattern, ISubformulaPattern{
    ...
    public IPLTwoLevelCompositeBinaryFormulaPattern(Connective mainFirstConnective, Connective mainSecondConnective, FormulaSign mainSign,
	...
	public boolean matches(SignedFormula main, SignedFormula auxiliary) {
        ...
        return lcMatch && a.getSignedFormula().getSign().equals(auxiliarySign)
                && m.getSignedFormula().getSign().equals(mainSign)
                && matchesSigned(m.getSignedFormula(), a.getSignedFormula());
    }

    private boolean matchesSigned(SignedFormula main, SignedFormula aux) {
